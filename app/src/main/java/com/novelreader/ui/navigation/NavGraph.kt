    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(Screen.Browse.route) {
                BrowseScreen(onNovelClick = { slug -> navController.navigate(Screen.Detail.createRoute(slug)) })
            }
            composable(Screen.Updates.route) {
                UpdatesScreen(onNovelClick = { slug -> navController.navigate(Screen.Detail.createRoute(slug)) })
            }
